...
**{project_name}** is a Harness Engineering v2 project generated by `harness-init`. {project_description} It provides a structured agent runtime with Planner, Generator, and Evaluator roles, wired together through a seven-stage workflow.
